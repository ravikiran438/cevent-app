...
ceventAppApp.controller('MainController', ['$scope',
    function ($scope) {
    }]);

ceventAppApp.controller('AdminController', ['$scope',
    function ($scope) {
    }]);
...
ceventAppApp.controller('MenuController', ['$scope',
    function ($scope) {
    }]);

ceventAppApp.controller('LoginController', ['$scope', '$location', 'AuthenticationSharedService',
...
ceventAppApp.controller('LogoutController', ['$location', 'AuthenticationSharedService',
...
ceventAppApp.controller('SettingsController', ['$scope', 'resolvedAccount', 'Account',
...
ceventAppApp.controller('PasswordController', ['$scope', 'Password',
...
ceventAppApp.controller('SessionsController', ['$scope', 'resolvedSessions', 'Sessions',
 ...
 ceventAppApp.controller('TrackerController', ['$scope',
    function ($scope) {
...
ceventAppApp.controller('MetricsController', ['$scope', 'resolvedMetrics', 'HealthCheckService',
...
ceventAppApp.controller('LogsController', ['$scope', 'resolvedLogs', 'LogsService',
